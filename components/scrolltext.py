...
import components.textLineNumbers as textLineNumbers
from highlighter.SVHihglighter import SVHighlighter
from highlighter.CHighlighter import CHighLighter
from autocompleter.UVMAutocompleter import UVMAutocompleter, uvm_classes, uvm_macros
