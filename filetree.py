...
class FileTree(ttk.Treeview):
    def __init__(self, root, *args, **kwargs):
        ...
        # Load icons
        self.folder_icon = ImageTk.PhotoImage(Image.open("folder-7-16.png").resize((16, 16), Image.ADAPTIVE))
        self.file_icon = ImageTk.PhotoImage(Image.open("report-3-16.png").resize((16, 16), Image.ADAPTIVE))
